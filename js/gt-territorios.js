// ============================================================
// LAUREAN — Departamentos y municipios de Guatemala
//
// Lista local (no depende de red) para el selector de entrega en el
// checkout. Si Forza está disponible, se prefiere su catálogo (trae
// HeaderCode para la guía); si no, se usa esta lista por nombre.
//
// window.GT_TERRITORIOS = { "Departamento": ["Municipio", ...], ... }
// ============================================================
(function () {
  window.GT_TERRITORIOS = {
